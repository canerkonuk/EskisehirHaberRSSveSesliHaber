...
public class ReadRss3 extends AsyncTask<Void,Void,Void>{
    Context context;
    String adress="http://www.sakaryagazetesi.com.tr/rss/const/7";
    ProgressDialog progressDialog;
    ArrayList<FeedItem> feedItems;
    RecyclerView recyclerView;
    URL url;
    public ReadRss3(Context context, RecyclerView recyclerView){
