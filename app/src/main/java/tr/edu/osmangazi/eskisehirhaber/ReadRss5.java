...
public class ReadRss5 extends AsyncTask<Void,Void,Void>{
    Context context;
    String adress="http://www.sakaryagazetesi.com.tr/rss.xml";
    ProgressDialog progressDialog;
    ArrayList<FeedItem> feedItems;
    RecyclerView recyclerView;
    URL url;
    public ReadRss5(Context context, RecyclerView recyclerView){
